  ...
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-[600] pointer-events-none px-4 w-full max-w-[420px] md:max-w-[380px] pb-safe-bottom">
      ...
      >
        <GlassLayer 
          layer={4} 
          className="pointer-events-auto flex items-center justify-between p-1.5 rounded-[30px] relative overflow-hidden group/dock bg-[#0a0a0a]"
        >
                  ...
                  <div className="relative mb-0.5">
                    <Icon 
                      className={`w-[22px] h-[22px] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                        isActive 
                          ? 'scale-110 stroke-[2.2px] text-cyan-400 animate-active-glow' 
